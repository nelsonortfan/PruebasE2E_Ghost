...
Update the url to visit in the files monkey_config.json and smart_monkey_config.json in the parameter baseUrl as you can see in the picture (also you can change the seed. For the results of this tests the seed used was 7655):

![Alt text](monkey_config.JPG)

If you are working with Windows, update the paths in the package.json with the paths:

![Alt text](package_json_windows.JPG)
...
\* Note2: If you work with Windows, open the terminal and in the path node_modules\\.bin of the folder, execute the command:
