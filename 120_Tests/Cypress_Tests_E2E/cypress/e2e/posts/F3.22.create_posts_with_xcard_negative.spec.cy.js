...
describe("Test create a post with an invalid xCard", () => {
  ...
  const postCases = [
    {
      description: "Create post with xcard title too long",
      post: {
        ...generatePost(),
        xCard: {
          ...generateXCard(),
    ...
    {
      description: "Create post with xcard description too long",
      post: {
        ...generatePost(),
        xCard: {
          ...generateXCard(),
