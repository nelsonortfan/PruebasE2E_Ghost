...
describe('Crear un nuevo miembro con nombre largo', () => {
    ...
    it('Create a new member with a big one word name', ()=>{
        // When - creo nombre y email largo con faker
        const newMemberName = faker.person.fullName()
        const newEmail = "loooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooong" + faker.internet.email()
