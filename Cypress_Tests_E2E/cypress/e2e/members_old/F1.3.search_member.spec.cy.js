...
describe('Buscar tres miembros previamente creados a través de la barra de búsqueda y verificar que sí salgan bien sus resultados', () => {
    ...
    it('Create 3 new member and search them', ()=>{
        ...
        screenshotTaker.screenshot("Nombre 1 ingresado")
        cy.get('input[name="email"]').type(newEmail)
        screenshotTaker.screenshot("Email 1 ingresado")
        ...
        screenshotTaker.screenshot("Nombre 2 ingresado")
        cy.get('input[name="email"]').type(newEmail2)
        screenshotTaker.screenshot("Email 2 ingresado")
        cy.get('button[class="gh-btn gh-btn-blue gh-btn-icon ember-view"]').click()
        cy.wait(1000)
        cy.goToPageOld("members")
        cy.wait(1000)
        ...
        screenshotTaker.screenshot("Nombre 3 ingresado")
        cy.get('input[name="email"]').type(newEmail3)
        screenshotTaker.screenshot("Email 3 ingresado")
        cy.get('button[class="gh-btn gh-btn-blue gh-btn-icon ember-view"]').click()
        cy.wait(1000)
        cy.goToPageOld("members")
        cy.wait(1000)
